...
(function() { this.JST || (this.JST = {}); this.JST["comment/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h4>Comments</h4>\n\n<div class="comments">\n</div>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["photo/gutter_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<img src="',  photo.escape("url") ,'" alt="photo-thumbnail"/>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>My Photos</h2>\n\n<div class="photos grid transitions-enabled infinite-scroll clearfix centered">\n\n    <div class="box col1"></div>\n    <div class="box col2"></div>\n    <div class="box col3"></div>\n    <div class="box col4"></div>\n    <div class="box col5"></div>\n    <div class="box col6"></div>\n    <div class="box col7"></div>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<div class="upload-form-map-container">\n    <h2 class="upload-form-heading">Upload Picture</h2>\n  <div class="upload-form-wrapper">\n    <form class="upload-form" action="index.html" method="post">\n\n      <label for="photo-title">Title:</label><br>\n      <input type="text" id="photo-title" value=""><br>\n\n      <label for="photo-desc">Description:</label><br>\n      <textarea id="photo-desc"\n                name="photo[description]"\n                rows="4" cols="20"\n                ></textarea><br>\n\n      <label for="album-id">Album:</label><br>\n      <select id="album-id">\n          <option value="0">No Album</option>\n        ');  albums.each(function(album) { ; __p.push('\n          <option value="',  album.id ,'"\n            >',  album.escape("title") ,'\n          </option>\n        ');   }); ; __p.push('\n      </select><br><br>\n\n\n      <input type="submit" value="Upload">\n    </form>\n  </div>\n  <div class="formpage-map"           id="formpage-map-canvas">\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/photo_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="photo-container grid-item">\n    <a href="',  "#photos/" + photo.id ,'">\n      <img src="',  photo.escape("url") ,'" alt="photo-thumbnail"/>\n    </a>\n    <p class="photo-title">\n      ',  photo.escape("title") ,'\n    </p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="photo_img">\n  <img src="',  photo.escape("url") ,'"/>\n</div>\n<div class="photo_title">\n  ',  photo.escape("title") ,'\n</div>\n<div class="comment-index">\n\n</div>\n<div class="new-comment-form">\n\n</div>\n');}return __p.join('');};
}).call(this);
...
Shuttr.Views.MapView = Backbone.View.extend ({
