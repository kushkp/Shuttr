...
(function() { this.JST || (this.JST = {}); this.JST["album/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>New Album</h2>\n\n<form class="new_album">\n  <label for="album_title">Title</label>\n  <input type="text" name="album[title]" id="album_title">\n\n  <input type="submit" value="Create Album!">\n</form>\n\n<a href="#">Back to Album Index</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["album/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="page-header">\n  <h2>Albums</h2>\n</div>\n\n<div class="albums album-grid transitions-enabled infinite-scroll clearfix centered">\n  <div class="box col1"></div>\n  <div class="box col2"></div>\n  <div class="box col3"></div>\n  <div class="box col4"></div>\n  <div class="box col5"></div>\n  <div class="box col6"></div>\n  <div class="box col7"></div>\n</div>\n\n<a href="#albums/new">New Album</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["album/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="album-grid-item album-container">\n  <a href="',  "#albums/" + album.id ,'" >\n    <img src="',  album.escape("url") ,'" alt="album-thumbnail"/>\n  </a>\n  <p class="album-title">\n    ',  album.escape("title") ,'\n  </p>\n</div>\n\n  <!-- <button type="button"\n          class="delete_album"\n          data-id="',  album.id ,'"\n          >Delete</button> -->\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["album/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>',  album.escape("title") ,'</h2>\n\n<div class="photos"></div>\n\n<br><br>\n\n<br>\n\n<a href="#">Back to My Albums</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["comment/comment_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="comment-item">\n  ');  if (Shuttr.CURRENT_USER.id === comment.escape("user_id")) { ; __p.push('\n    <button type="button"\n            class="close delete-comment glyphicon glyphicon-trash"\n            data-id="',  comment.id ,'">\n    </button>\n  ');  } ; __p.push('\n  <span class="comment-item-author">\n    ',  comment.escape("author_name") ,':\n  </span><br>\n  <span class="comment-item-body">\n    ',  comment.escape("body") ,'\n  </span>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["comment/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="new-comment-form-wrapper">\n  <form class="new-comment-form" action="index.html" method="post">\n    <textarea name="comment[body]"\n              rows="2"\n              style="resize: none"\n              placeholder="Type comment here..."\n              ></textarea><br>\n    <input class="post-comment-btn btn primary-btn" type="submit" value="Post Comment">\n  </form>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["comment/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="comment-list-wrapper">\n  <h4>Comments</h4>\n\n  <div class="comments">\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["map/container"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="map-canvas" class="map-container"></div>\n<div class="photo-gutter"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["nav/navbar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<nav class="navbar navbar-default">\n  <div class="container-fluid">\n\n    <div class="navbar-header">\n\n      <a class="navbar-brand" href="#">Shuttr</a>\n\n      <button type="button" class="navbar-toggle collapsed"\n              data-toggle="collapse"\n              data-target="#collapse-menu"\n              aria-expanded="false">\n      </button>\n    </div>\n\n    <div class="collapse navbar-collapse" id="collapse-menu">\n      <ul class="nav navbar-nav pull-right">\n          <li>\n            <a href="#" data-toggle="dropdown" class="dropdown-toggle">\n              ',  Shuttr.CURRENT_USER.name ,'\n              <b class="caret"></b></a>\n            <ul class="dropdown-menu">\n              <li><a href="#albums">My Albums</a></li>\n              <li><a href="#photos">My Photos</a></li>\n              <li><a class="sign-out-link"\n                     href="javascript:void(0)"\n                     >Sign Out</a></li>\n            </ul>\n          </li>\n      </ul>\n\n      <ul class="nav navbar-nav navbar-left">\n        <li><a href="#">Explore</a></li>\n        <li><a href="#map">Map</a></li>\n        <li>\n          <a class="create-photo-btn"\n               href="javascript:void(0)">Create</a>\n        </li>\n      </ul>\n    </div>\n\n  </div>\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/explore"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="page-header">\n  <h1>Explore</h1>\n</div>\n\n<div class="photos grid transitions-enabled infinite-scroll clearfix centered single-item">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/gutter"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="gutter-photo-index"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/gutter_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a class="gutter-item-link" href="javascript:void(0)">\n  <img class="gutter-item-img"\n      data-id="',  photo.id ,'"\n       src="',  photo.escape("url") ,'"\n       alt="photo-thumbnail"/>\n</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="page-header">\n  <h2>My Photos</h2>\n</div>\n\n<div class="photos grid transitions-enabled infinite-scroll clearfix centered">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/large_modal"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="prev-image"><<i class="fa fa-angle-left"></i></div>\n<div class="next-image"><i class="fa fa-angle-right">></i></div>\n<div class="close close-gallery-modal">&times;</div>\n\n<div class="active-image">\n  <img src="',  photo.escape('url') ,'">\n</div>\n<div class="large-modal-bg"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="m-background"></div>\n<div class="m-content upload-form-map-container col-md-8-offset-2">\n  <button class="close">&times;</button>\n  <h2 class="upload-form-heading">Upload Picture</h2>\n\n  <div class="upload-form-wrapper">\n    <form class="upload-form" action="index.html" method="post">\n\n      <label for="photo-title">Title:</label><br>\n      <input type="text" name="photo[title]" id="photo-title" value=""><br>\n\n      <label for="photo-desc">Description:</label><br>\n      <textarea id="photo-desc"\n                name="photo[description]"\n                rows="5"\n                ></textarea><br>\n\n      <label for="album-id">Album:</label><br>\n      <select id="album-id">\n          <option value="0">No Album</option>\n        ');  albums.each(function(album) { ; __p.push('\n          <option value="',  album.id ,'"\n            >',  album.escape("title") ,'\n          </option>\n        ');   }); ; __p.push('\n      </select><br><br>\n\n\n      <input type="submit" class="btn btn-primary new-photo-submit centered" value="Upload">\n    </form>\n  </div>\n  <span>Select Location:</span>\n  <div class="formpage-map"\n       id="formpage-map-canvas">\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/photo_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="photo-container grid-item">\n    <!-- <a href="/#photos/',  photo.id ,'"> -->\n    <a href="javascript:void(0)">\n      <img data-id="',  photo.id ,'"\n           src="',  photo.escape("url") ,'"\n           alt="photo-thumbnail"/>\n    </a>\n    <p class="photo-title">\n      ',  photo.escape("title") ,'\n      ');  if (inMyPhotos) { ; __p.push('\n          <button class="close delete-photo glyphicon glyphicon-trash"></button>\n      ');  } ; __p.push('\n    </p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photo/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="m-background">\n  <button class="close close-photo-show">&times;</button>\n</div>\n<div class="photo-show-content col-md-2-offset-5">\n  <div class="photo-show-img">\n    <img src="',  photo.escape("url") ,'"/>\n  </div>\n\n  <div class="photo-info">\n    <div class="photo-show-title">\n      ',  photo.escape("title") ,'\n    </div>\n\n    <div class="comment-index"></div>\n    <div class="new-comment-form"></div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
